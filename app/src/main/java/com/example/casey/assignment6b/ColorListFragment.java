...
/**
 * A list fragment representing a list of Colors. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link BlueFragment}.
 * <p/>
...
public class ColorListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(ColorContent.ITEMS.get(position).id);
    }
