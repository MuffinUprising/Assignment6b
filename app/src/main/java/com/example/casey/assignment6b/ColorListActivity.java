 ...
 * (if present) is a {@link BlueFragment}.
 * <p/>
...
public class ColorListActivity extends FragmentActivity
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            //TODO: add some kind of if statement to switch between fragments??
            //Im really not sure what the proper way to set this up would be

            arguments.putString(BlueFragment.ARG_ITEM_ID, id);
            BlueFragment fragment = new BlueFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.blue_fragment, fragment)
                    .commit();
            ...
            detailIntent.putExtra(BlueFragment.ARG_ITEM_ID, id);
